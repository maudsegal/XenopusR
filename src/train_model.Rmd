...
for(f in folders){
  ...
  for(file in filelist){
    ...
    gentestdata <- askYesNo("generate testdata?", default = "no")
...
gibbonID(input.dir="./input/trainingdata",output.dir="./output/test/",win.avg='standard',add.spectrograms=TRUE,min.freq=min.freq,max.freq=max.freq,class='no.clustering')

gibbonID(input.dir="./input/trainingdata",output.dir="./output/test/",win.avg='standard',class='affinity.fixed', q.fixed=0.1,add.spectrograms=TRUE,min.freq=min.freq,max.freq=max.freq)
```
